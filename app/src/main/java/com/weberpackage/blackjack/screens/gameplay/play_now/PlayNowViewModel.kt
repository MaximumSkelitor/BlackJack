package com.weberpackage.blackjack.screens.gameplay.play_now
...
import com.weberpackage.blackjack.screens.dashboard.sections.rank_section.RankUtils

class PlayNowViewModel(private val preferenceManager: PreferenceManager) : ViewModel() {
    private val deck = Deck()
    private val player = Player(chips = preferenceManager.getChips()).apply {
