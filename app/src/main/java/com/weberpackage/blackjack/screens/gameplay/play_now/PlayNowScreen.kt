...
fun PlayNowScreen(
    ...
    preferenceManager: com.weberpackage.blackjack.coredata.PreferenceManager,
    onUpdateChips: () -> Unit = {},
    ...
    // Refresh global chips whenever totalChips in this VM changes
    androidx.compose.runtime.LaunchedEffect(totalChips) {
        onUpdateChips()
    }
